  ...
  return (
    <section className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="w-full h-[450px] rounded-[3rem] overflow-hidden shadow-2xl shadow-black/5 border border-border/50 relative group">
          <iframe
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        ...
        <h2 className="text-4xl md:text-6xl font-serif font-bold text-foreground mb-4 italic">
