    ...
    <LayoutWrapper>
      <main className="min-h-screen bg-background">
        ...
        <div className="relative h-[60vh] md:h-[65vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 text-center text-white pt-16 md:pt-12">
            <div className="mb-8 md:mb-10 animate-fade-in">
              <Breadcrumbs items={[{ label: 'About Us' }]} />
            </div>
            <div className="inline-block py-2 px-6 bg-primary/20 backdrop-blur-md border border-primary/30 rounded-full mb-6 md:mb-8 animate-fade-in [animation-delay:200ms] transition-transform hover:scale-105 duration-500 gpu-accel">
              <span className="text-[10px] font-bold text-white tracking-[0.4em] uppercase">Our Story</span>
            </div>
            <h1 className="text-5xl md:text-9xl font-serif font-bold mb-8 md:mb-10 leading-[1.1] md:leading-[0.9] animate-fade-in [animation-delay:400ms] italic tracking-tighter drop-shadow-2xl">
              About <br /><span className="text-primary">Residency</span>
            </h1>
            <div className="w-24 h-1 bg-primary/40 mx-auto mb-8 md:mb-10 rounded-full animate-fade-in [animation-delay:500ms]" />
            <p className="text-lg md:text-xl text-white max-w-3xl mx-auto font-light leading-relaxed animate-fade-in [animation-delay:600ms] gpu-accel drop-shadow-md px-4">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 py-20 md:py-32">
          ...
          <section className="mb-24 md:mb-40">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
              <div className="animate-fade-in [animation-delay:800ms]">
                <h2 className="text-3xl md:text-6xl font-serif font-bold text-foreground mb-6 md:mb-10 leading-tight">
              ...
              <div className="relative animate-fade-in [animation-delay:1000ms] h-full">
                <div className="aspect-square rounded-[3rem] md:rounded-[4rem] relative overflow-hidden group shadow-2xl border border-border/20">
                  <Image 
                  ...
                  <div className="text-center relative z-10 p-8 md:p-12 h-full flex flex-col items-center justify-center transform group-hover:translate-y-[-10px] transition-transform duration-700">
                    <Heart className="w-16 h-16 md:w-20 md:h-20 text-white mb-4 md:mb-6 mx-auto stroke-[1.5] drop-shadow-lg" />
          ...
          <section className="mb-24 md:mb-40">
            <div className="text-center mb-16 md:mb-24 animate-fade-in">
                <h2 className="text-4xl md:text-7xl font-serif font-bold text-foreground mb-6 md:mb-8 text-center leading-tight">
                Our Core Values
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              {[
                ...
                <div key={i} className="group bg-card border border-border/50 rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-12 transition-all duration-700 hover:shadow-2xl hover:shadow-black/5 hover:-translate-y-2 animate-fade-in" style={{ animationDelay: `${1200 + i * 200}ms` }}>
                  <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-primary/5 flex items-center justify-center text-primary mb-8 md:mb-10 group-hover:bg-primary group-hover:text-white transition-all duration-700">
                    <div className="scale-75 md:scale-100">{value.icon}</div>
                  </div>
                  <h3 className="text-2xl md:text-3xl font-serif font-bold text-foreground mb-4 md:mb-6">{value.title}</h3>
          ...
          <section className="p-10 md:p-24 rounded-[3rem] md:rounded-[4rem] bg-muted/50 border border-border/50 relative overflow-hidden animate-fade-in [animation-delay:1800ms]">
            <div className="absolute inset-0 bg-[url('/luxury-pattern.svg')] opacity-5" />
            <div className="relative z-10">
                <h2 className="text-3xl md:text-6xl font-serif font-bold text-foreground mb-12 md:mb-20 text-center leading-tight">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
                    {[
                        ...
                        <div key={i} className="flex flex-col sm:flex-row gap-6 sm:gap-8 group">
                            <div className="flex-shrink-0 w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-white border border-border/50 flex items-center justify-center text-primary shadow-sm group-hover:scale-110 transition-transform duration-500">
                                <div className="scale-75 md:scale-100">{item.icon}</div>
                            </div>
                            <div>
                                <h3 className="text-xl md:text-2xl font-serif font-bold text-foreground mb-3 md:mb-4">{item.title}</h3>
